...
class Property_Speed(Property_Enum):
    ...
    def __init__(self, node, id='speed', name='Speed', settable=True, retained=True, qos=1, unit=None, data_type='enum', data_format='OFF,LOW,MEDIUM,HIGH', value=None, set_value=None):
