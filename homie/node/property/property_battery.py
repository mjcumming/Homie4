...
class Property_Battery(Property_Integer):
    ...
    def __init__(self,node, id='battery', name = 'Battery', settable = False, retained = True, qos=1, unit = '%', data_type= None, data_format = '0:100', value = None, set_value=None, tags=[], meta={}):
